...
public class CommonController implements ControllerConstants{
	...
	/**
	 * 인증된 사용자 정보 Map에 세팅
	 * @return Map - 인증된 관리자 정보(IP정보 포함)	
	 */
	public Map<String, Object> getAuthUserInfo(){
		Map<String, Object> returnMap = new HashMap<String, Object>();
		MemberVo memberVo = (MemberVo)getAuthenticatedUser();
		if(memberVo != null){
			returnMap.put("REG_ID", memberVo.getMbr_id());		
			returnMap.put("CHG_ID", memberVo.getMbr_id());		
		}
		return returnMap;
	}
    ...
    public void writeExcel (
		...
		InputStream is = new BufferedInputStream(new FileInputStream(WebUtils.getRealPath(request.getSession().getServletContext(), templateURL)));
	 ...
	 * @throws Exception
	 */
    public List<Map<String, Object>> getCodeList(int no) throws Exception {
    	Map<String, Object> param = new HashMap<String, Object>();
    	param.put("no", no);
    	List<Map<String, Object>> resultList = codeService.getCodeList(param);
    	return resultList;
    }
	 ...
	 * @throws Exception
	 */
    public List<Map<String, Object>> getCodeList(String sqlNo, int no, String pa1) throws Exception {
    	Map<String, Object> param = new HashMap<String, Object>();
    	param.put("sqlNo", sqlNo);
    	param.put("no", no);
    	param.put("pa1", pa1);
    	List<Map<String, Object>> resultList = codeService.getCodeList(param);
    	return resultList;
